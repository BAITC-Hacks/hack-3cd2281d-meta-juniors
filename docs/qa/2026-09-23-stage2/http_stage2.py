"""Real HTTP preview/confirm audit. Run against disposable QA port 8011 only."""
...
a.BASE="http://127.0.0.1:8011"
a.OUT=OUT
a.FIXTURES=OLD/"fixtures"
a.report={"code_commit":"e4a146e","checkout":"ae5bfad","base_url":a.BASE,"method":"Real HTTP, cookiejar, CSRF. No live AI.","checks":{}}
